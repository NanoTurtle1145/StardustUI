...
INT32 xapi_drawSvg(HDLE handle, UINT32 x, UINT32 y, UINT32 width, WSTR svgText, bool enableTrans = false);

INT32 xapi_drawFA(HDLE handle, UINT32 x, UINT32 y, UINT32 width, char *name, bool enableTrans = false);
...
void xapi_ButtonEmp(HDLE handle, UINT64 CRLid, UINT64 x, UINT64 y, WSTR text);
